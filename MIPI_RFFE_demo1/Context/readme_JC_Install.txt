...
Rev 2   05/22/2010 JC  Add use of ~.reg files.
                       *************************
                       *** Use at your risk ****
                       *************************

To add TEV custimization use eith of these two methods:
 1. Copy the following files:
    cp C:\AXITest\AppTemplate\Context\DD48 Pattern.ctpl                 C:\Program Files\ConTEXT\Template\
    cp C:\AXITest\AppTemplate\Context\MVP Multisite Virtual Pin.ctpl    C:\Program Files\ConTEXT\Template\
    cp C:\AXITest\AppTemplate\Context\DD48_pattern.chl                  C:\Program Files\ConTEXT\Highlighters\
    cp C:\AXITest\AppTemplate\Context\mvp_pinmapping.chl                C:\Program Files\ConTEXT\Highlighters\

    For Win7:
    execute ConTEXT_TEV_w7.reg

    For XP:
    execute ConTEXT_TEV_xp.reg
